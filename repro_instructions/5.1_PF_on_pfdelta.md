...
The training runs that match the paper CSVs are in the same repo under [`mlflow/`](https://huggingface.co/gridfm/genco-pfdelta/tree/main/mlflow) (`bs64_same_norm_shuffle_train_paper_seed{1,2,3}` only).
