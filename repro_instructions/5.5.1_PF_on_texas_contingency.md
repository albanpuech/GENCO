...
The training grid and each `test_<k>` raw table are in the same repo at `data/<split>/Texas2k_case1_2016summerpeak/raw/`. `--data_path` is `genco-pf-contingency-base/data/<split>`.
