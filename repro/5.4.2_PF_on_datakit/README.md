...
This covers the residual-vs-grid-size plot (`fig:gridsize_vs_residuals_pf`). The runtime figures and speedup columns are in [5.4.2-3_Runtime](../5.4.2-3_Runtime/README.md).
